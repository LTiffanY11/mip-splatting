...
class GaussianModel:
    ...
    def get_scaling_with_3D_filter(self):
        ...
        scales = torch.square(scales) + torch.square(self.filter_3D * self.filter_3D_scale)
    ...
    def get_opacity_with_3D_filter(self):
        ...
        scales_after_square = scales_square + torch.square(self.filter_3D * self.filter_3D_scale) 
        det2 = scales_after_square.prod(dim=1) 
        coef = torch.sqrt(det1 / det2)
        return opacity * coef[..., None]

    def set_filter_3D_scale(self, scale):
        self.filter_3D_scale = scale
